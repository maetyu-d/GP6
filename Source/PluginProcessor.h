...
class AfricanRhythmsAudioProcessor  : public juce::AudioProcessor,
                                      private juce::AudioProcessorValueTreeState::Listener
{
public:
    AfricanRhythmsAudioProcessor();
    ~AfricanRhythmsAudioProcessor() override;
    ...
    RhythmSnapshot getSnapshot() const;
...
private:
    ...
    RhythmEngine::Settings currentSettings() const;
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(AfricanRhythmsAudioProcessor)
};
