...
const std::vector<ErhcetuaAudioProcessor::PresetDefinition>& ErhcetuaAudioProcessor::getPresets()
{
    static const std::vector<PresetDefinition> presets {
        ...
        { "Null Staircase", 1, 0, 2, 1, 0.42f, 0.49f, 0.18f, 0.06f, 3, 0.12f, 0.3f, 0.36f, 0.97f, 0.03f, 57, 2, 0.48f, 1 },
        { "Signal Cartography", 4, 3, 4, 3, 0.69f, 0.63f, 0.38f, 0.34f, -1, 0.1f, 0.61f, 0.71f, 0.82f, 0.16f, 40, 4, 0.29f, 1 },
